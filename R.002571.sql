...
Name: Dewey number circulation of your collection at your library in a given month
...
Created on: 2015-07-28 17:38:16
Modified on: 2015-09-10 15:12:22
Date last run: 2017-08-24 16:40:19
...
Circulation of your collection's Dewey numbers at your library (grouped by Dewey numbers and location) during a set month. From the dropdowns, choose your library, a month, and a year. 
...
WHERE i.homebranch=<<choose your library|branches>> AND month(s.datetime)=<<Choose Month|Month>> AND year(s.datetime)=<<Choose Year|Year>> AND s.type IN ('issue','renew') AND s.branch=<<choose your library|branches>>
