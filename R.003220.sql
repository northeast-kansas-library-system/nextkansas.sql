...
Date last run: 2022-12-13 10:47:37
...
SELECT Concat_Ws("",
  ...
  Concat("AUDIOBOOK Item record/bibliogrphic record problem - ", items.biblionumber, "Hello at ", items.homebranch, ","),
  ...
  Concat("The collection code on your item (", ccodes.lib, ") doesn't match many of the descriptive elements on this bibliographic record."),
  ...
  "", 
  Concat("Could you take a look at this item and bring the record up to date as needed.  If, for example, the item record is incorrect, you could just modify the record.  Or, if this item belongs on a different bibliographic record, could you move it to a different record or import a better bibliographic record and attach this item to that record?  If you need any help with this issue, please respond with the item barcode number from this item, the UPC code from the the item, plus the full title of the item as it appears on the cover or on the video game itself.  Also, if you need help, if you could actually take a photo of the cover of this item and send that in, although not necessary, that would be a big help too.Thanks,")
) AS INFO
FROM biblio
