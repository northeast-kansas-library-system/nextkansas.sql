...
Name: GHW - ADMINREPORT - Item dashboard
...
Modified on: 2020-10-24 22:21:05
Date last run: 2021-02-05 11:02:32
...
SELECT
  Concat_Ws('<br />',
    ...
    Concat("<br /><a href='/cgi-bin/koha/reports/guided_reports.pl?phase=Run+this+report&reports=3009&sql_params=", Replace(Replace(Replace(Replace(Replace(Replace(Replace(deleteditems.barcode, Char(43), "%2B"), Char(47), "%2F"), Char(32), "%20"), Char(45), "%2D"), Char(36), "%24"), Char(37), "%25"), Char(46), "%2E"), "&limit=50' target='_blank'>Search fine and fees history for this item barcode number</a>"),
