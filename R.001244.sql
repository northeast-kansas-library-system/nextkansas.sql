...
Date last run: 2026-01-27 16:52:34
...
SELECT COUNT(&ast;) FROM statistics WHERE statistics.type IN ('issue','renew') AND statistics.datetime LIKE &lt;&gt; AND statistics.branch = &lt;&gt; 
