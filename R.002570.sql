...
Name: Dewey number circulation of your collection in a given month
...
Created on: 2015-07-16 22:16:18
Modified on: 2015-09-10 14:51:49
Date last run: 2021-02-05 12:00:34
...
Circulation of your library's Dewey numbers  (grouped by Dewey numbers and location) during a set month at any library. Choose your library once from the dropdown; then choose month and choose year.
...
WHERE i.homebranch=<<choose your library|branches>> AND month(s.datetime)=<<choose month|Month>> AND year(s.datetime)=<<choose year|Year>> AND s.type IN ('issue','renew')
