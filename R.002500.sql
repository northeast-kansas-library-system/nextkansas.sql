...
Name: Basehor Collection Size, Based on Call Number Groups
...
Created on: 2015-05-15 17:00:56
Modified on: 2015-05-15 17:04:48
Date last run: -
...
Returns total items added through a specified date, based on call number breakdown. <a href="https://staff.nexpresslibrary.org/cgi-bin/koha/reports/guided_reports.pl?reports=2499&phase=Run%20this%20report" target="_blank"><b>Run report #2499</b></a> to get total circ for this grouping of call numbers.
...
SELECT 
	...
	END "groups", COUNT(i.itemnumber) as total_items
FROM items i
WHERE i.homebranch='BASEHOR' AND i.dateaccessioned <= <<enter last date of month you're counting stats on, like 2015-04-30>>
