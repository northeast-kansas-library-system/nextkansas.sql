...
Name: GHW - Rules 001b - fee rules only
...
Created on: 2026-07-23 17:34:30
Modified on: 2026-07-23 17:36:26
Date last run: 2026-07-23 17:40:20
...
SELECT
  ...
  CASE
    WHEN rules_table.chargeperiod_charge_at = 0
    THEN 'End of interval'
    WHEN rules_table.chargeperiod_charge_at = 1
