...
Created on: 2021-01-25 09:42:07
Modified on: 2021-01-25 09:45:26
Date last run: 2021-01-25 10:21:17
...
SELECT
  ...
  Concat_Ws(" - ", 
    ExtractValue(biblio_metadata.metadata, '//datafield[@tag="700"]/subfield[@code="a"]')
  ) AS ADD_AUTHOR,
  Concat(
