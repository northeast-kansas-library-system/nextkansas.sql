...
Date last run: 2026-06-24 17:16:09
...
WHERE
  borrowers.branchcode LIKE <<Choose borrower home library|branches:all>> AND
  borrowers.categorycode LIKE '%' AND
  expired_account.attribute LIKE <<Select expiration attribute|EXPIRED:all>>
GROUP BY
  borrowers.borrowernumber
ORDER BY
  borrowers.dateexpiry,
