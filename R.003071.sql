...
Modified on: 2018-12-13 16:20:51
Date last run: 2019-07-17 09:27:22
...
FROM
  ...
  LEFT JOIN (SELECT
      ...
      GROUP BY
        issues.borrowernumber,
        issues.itemnumber,
        issues.date_due) overdues ON borrowers.borrowernumber = overdues.borrowernumber
  LEFT JOIN (SELECT
      ...
      GROUP BY
        accountlines.borrowernumber) fees ON borrowers.borrowernumber = fees.borrowernumber
WHERE
