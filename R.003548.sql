...
Name: GHW - Monthly borrower count by zipcode - in progress
...
Modified on: 2021-08-04 16:24:17
Date last run: 2021-08-04 16:24:35
...
FROM
  ...
  (SELECT
    ...
    GROUP BY
      ...
      deleted_lm.zipcode = branchcodeszipss.ZIPCODE
GROUP BY
  branches.branchname,
  branchcodeszipss.ZIPCODE
