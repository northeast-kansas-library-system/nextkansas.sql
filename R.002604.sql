...
Name: Dewey number circulation of your collection at your library in a given year
...
Created on: 2015-09-10 15:12:43
Modified on: 2015-09-10 15:12:43
Date last run: -
...
Circulation of your collection's Dewey numbers at your library (grouped by Dewey numbers and location) during a set month. From the dropdowns, choose your library and a year. 
...
WHERE i.homebranch=<<choose your library|branches>> AND year(s.datetime)=<<Choose Year|Year>> AND s.type IN ('issue','renew') AND s.branch=<<choose your library|branches>>
