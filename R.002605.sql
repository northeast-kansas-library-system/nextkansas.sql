...
Name: Dewey number circulation of your collection in a given year
...
Created on: 2015-09-10 15:13:47
Modified on: 2015-10-20 19:24:35
Date last run: -
...
Circulation of your library's Dewey numbers  (grouped by Dewey numbers and location) during a set month at any library. From the dropdowns, choose your library and a year. 
...
WHERE i.homebranch=<<choose your library|branches>> AND year(s.datetime)=<<choose year|Year>> AND s.type IN ('issue','renew')
