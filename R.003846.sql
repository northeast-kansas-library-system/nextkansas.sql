...
<div class="reportinfo noprint"> 
  <p>Creates a list of new adult book ISBNs for the Wordpress bookshelves plugin for EUDORA</p>
  <ul>
    <li>Shows the 25 most recently added 10 digit ISBNs for items owned by EUDORA</li>
    <li>only titles owned by EUDORA</li>
