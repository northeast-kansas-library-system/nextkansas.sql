...
Created on: 2019-05-24 21:28:54
Modified on: 2019-06-14 10:31:57
Date last run: 2019-08-02 10:54:23
...
SELECT
  ...
  Concat_Ws("<br />", If(borrowers.flags MOD 2, 'AAA - (superlibrarian) Access to all librarian functions', ''), If(MOD(borrowers.flags DIV 2, 2), '(circulate) Check out and check in items', GROUP_CONCAT(If(user_permissions.module_bit = 1, permissions.code, '') SEPARATOR ' '))) AS PERM,
