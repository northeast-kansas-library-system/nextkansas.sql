...
Modified on: 2017-02-14 14:08:29
...
FROM
  ...
  accountlines payments
    ON payments.accountlines_id = offsets.accountlines_id INNER JOIN
  accountlines paid
    ON offsets.ACCTLINE = paid.accountlines_id INNER JOIN
  borrowers staff
    ON payments.manager_id = staff.borrowernumber INNER JOIN
  borrowers patron
