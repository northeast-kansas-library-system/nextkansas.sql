...
Name: Dewey number circulation at your library in a given year
...
Created on: 2015-09-10 15:11:18
Modified on: 2015-09-10 15:11:18
Date last run: 2018-01-31 17:24:35
...
Circulation of Dewey numbers (grouped by Dewey numbers and location) during a set year at your library (items from any collection). From the dropdown menus, choose year, and your library. 
...
WHERE year(s.datetime)=<<Choose Year|Year>> AND s.type IN ('issue','renew') AND s.branch=<<choose your library|branches>>
