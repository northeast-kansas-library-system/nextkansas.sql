...
Modified on: 2026-01-30 17:26:04
Date last run: 2026-04-01 00:15:02
...
<!-- Overview -->
  ...
  <div class="next_report_summary">
    ...
    <p id="report_id"><strong>Report number:</strong> 3422</p>

    <p id="report_name"><strong>Report name:</strong> 0025 - 2024_99_a_cy monthly_statistics</p>
...
<!-- Function section -->
    <div id="accordion_3422-1" class="accordion-item next_report_function">

      <h2 class="accordion-header" id="panelsStay_3422Open-headingOne" >

        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
          data-bs-target="#panelsStay_3422Open-collapseOne" aria-expanded="true"
          aria-controls="panelsStay_3422Open-collapseOne">
      ...
      <div id="panelsStay_3422Open-collapseOne" class="accordion-collapse collapse"
        aria-labelledby="panelsStay_3422Open-headingOne">
        <div class="accordion-body">

          <div id="function_section" class="report_section">


            <p>Gathers holding statistics for the monthly overview report</p>
            ...
            <span style="display: none;">
              <li><strong>GROUPED BY:</strong> </li>
            </span>
            ...
            <span>
            <p>Runs in 00:00:01 // tested 2026-01-30</p>
            </span>
...
<!-- Notes section -->
    <div id="accordion_3422-2" class="accordion-item next_report_notes ">

      <h2 class="accordion-header" id="panelsStay_3422Open-headingTwo">

        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
          data-bs-target="#panelsStay_3422Open-collapseTwo" aria-expanded="false"
          aria-controls="panelsStay_3422Open-collapseTwo">
      ...
      <div id="panelsStay_3422Open-collapseTwo" class="accordion-collapse collapse"
        aria-labelledby="panelsStay_3422Open-headingTwo">
        <div class="accordion-body">
...
<!-- Direct download section -->
  <div class="next_report_direct_download ">
    <p><a href="/cgi-bin/koha/reports/guided_reports.pl?op=export&format=csv&id=3422" class="direct_download_btn">Download directly to a CSV file</a></p>
  </div>
