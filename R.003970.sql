...
Name: GHW - Rules 001c - hold and request rules
...
Created on: 2026-07-23 17:46:49
Modified on: 2026-07-28 17:20:33
Date last run: 2026-07-25 22:18:31
...
SELECT
  ...
  CASE
    WHEN rules_table.opacitemholds = 'N'
    THEN "Don't allow"
    WHEN rules_table.opacitemholds = 'Y'
    THEN 'Allow'
    WHEN rules_table.opacitemholds = 'F'
    THEN 'Force'
