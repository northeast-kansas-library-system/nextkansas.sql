...
Date last run: 2026-05-08 10:39:09
...
SELECT
  ...
  CONCAT(
    '<a href=\"', 
    '/cgi-bin/koha/reports/guided_reports.pl?op=run&id=2773',
    '&sql_params=', 
    (Left(borrowers.cardnumber, <<Number of digits in card prefix|YNUMBER>>)),
    '&param_name=Card+prefix',
    '&limit=1000', 
    ' \" target="_blank">Link to report 2773</a>' 
