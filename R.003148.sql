...
SELECT
  ...
  "Find this title in our catalog athttps://nextkansas.org//cgi-bin/koha/opac-detail.pl?biblionumber=", biblio.biblionumber) AS POST
FROM
  biblio
...
GROUP BY
  Concat("Recently added book: ", biblio.title, "Summary:",
  ExtractValue(biblio_metadata.metadata, '//datafield[@tag="520"]//subfield[@code="a"]'),
  "Find this title in our catalog athttps://nextkansas.org//cgi-bin/koha/opac-detail.pl?biblionumber=", biblio.biblionumber),
  biblio.biblionumber
HAVING
