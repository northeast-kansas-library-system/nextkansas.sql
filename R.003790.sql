...
SELECT Concat_Ws(
    ...
    Concat('<br />Problem with ', branches.branchname, ' item ', items.barcode, '<br />'),
    Concat(
      '<br />Hello at ',
      branches.branchname,
      ',<br />'
    ),
    'There appears to be a problem with the following item owned by your library.<br />',
    '----------',
    ...
    '----------<br />',
    Concat(
      '<br />The shelving location on this item appears to be incorrect.  Could you take a look to verify that "',
      permanent_locs.lib,
      '" is the correct shelving location for this item?<br />'
    ),
    Concat(
      '<br />The item type on this item appears to be incorrect.  Could you take a look to verify that "',
      itypes.description,
      '" is the correct item type for this item?<br />'
    ),
    Concat(
      '<br />The collection code on this item appears to be incorrect.  Could you take a look to verify that "',
      ccodes.lib,
      '" is the correct collection code for this item?<br />'
    ),
    '<br />Thanks,<br />'
  ) AS INFO
FROM biblio
...
WHERE items.barcode LIKE Concat('%', <<Enter barcode number>>, '%')
