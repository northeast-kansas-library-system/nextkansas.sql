...
----------
  ...
  Creates a list of new adult book ISBNs for the Wordpress bookshelves plugin for LYNDON
  
    Shows the 25 most recently added 10 digit ISBNs for items owned by LYNDON
    only titles owned by LYNDON
